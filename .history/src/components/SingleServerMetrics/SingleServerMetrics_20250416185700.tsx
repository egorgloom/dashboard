...
<section className="system-resources">
  ...
  <div className="system-resources--resource-item">
    <span className="system-resources--resource-item--label">CPU Usage</span>
    <span className="system-resources--resource-item--value">55%</span>
  </div>
  <div className="resource-item">
    <span className="system-resources--resource-item--label">Memory Usage</span>
    <span className="system-resources--resource-item--value">83%</span>
  </div>
  <div className="resource-item">
    <span className="system-resources--resource-item--label">Disk Usage</span>
    <span className="system-resources--resource-item--value">71%</span>
  </div>
</section>
