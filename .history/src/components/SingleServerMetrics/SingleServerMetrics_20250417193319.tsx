            ...
            <div className='single-item'>
                ...
                <div className='single-item__block'>
                    <div className='single-item__block-metric'>
                        ...
                        <MetricsChart 
                        item={data} 
                        elem3={data?.location?.historicalData?.responseTime}
                        elem2={data?.location?.historicalData?.rps}
                    ...
                    <div className='single-item__block-metric'>
                        ...
                        <MetricsChart 
                        item={data} 
                        elem3={data?.location?.historicalData?.cpu}
                        elem2={data?.location?.historicalData?.memory}
                        title1={'Memory'}
                        title2={'CPU'}
                        />
                        </div>
