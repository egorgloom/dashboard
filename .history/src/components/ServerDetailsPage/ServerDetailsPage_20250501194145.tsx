...
import { AllErrorCount, IErrorCount, IErrors, IMetrics } from '../../interfaces/interface';
...
const SingleServerMetrics: FC = () => {
    ...
    const totalCountErrors: AllErrorCount[] = useMemo(() => {
return getTotalCountErrors(data, 'h1')
    }, [data, 'h1'])

    console.log(totalCountErrors)
            ...
            <div className='single-item'>
                ...
                <section className="system-resources">
                    ...
                    <div className='system-resources__wrapper '>
                        {totalCountErrors.map((err: AllErrorCount) =>

                                <div key={Object.keys(err)[0]}>
                                    <h4>{Object.keys(err)[0]} Error</h4>
                                    <span>Count: {err[Object.keys(err)[0]]}</span>
                                </div>
                        )}
                    </div>
                </section>
