...
import { IErrorCount, IErrors } from '../../interfaces/interface';
...
const SingleServerMetrics: FC = () => {
    ...
    function count(data: any, key: any) {


        return data?.error?.h1?.reduce((total: any, entry: any) => {
            return total + (entry.count4xx || 0);
        }, 0)
    }

    console.log(data?.errors?.h1)
