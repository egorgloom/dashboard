      ...
      <div className='item'>
        <Link to={`/metrics/${averages.id}`}>
          <div className="item__name">
            <h2 className="item__name__header">{averages.server} Server</h2>
            <span className="item__name__server">server-{averages.id}</span>
          </div>
          <div className="item__data">
            ...
            <div className="item__data__info">
              ...
              <span className="item__data__info__value">{averages.rps}ms</span>
            </div>
            <div className="item__data__info">
              <span className="item__data__info__name">CPU</span>
              <span className="item__data__info__value">{averages.cpu}136ms</span>
            </div>
            <div className="item__data__info">
              <span className="item__data__info__name">Memory</span>
              <span className="item__data__info__value">{averages.memory}ms</span>
            </div>
          </div>
