        ...
        <Link to={`/metrics/${elem.id}`}>
          ...
          <div className="item__data">
            ...
            <div>
              ...
              <span className="all-cards__info__value">{elem.rps}ms</span>
            </div>
            <div>
              <span className="all-cards__info__name">CPU</span>
              <span className="all-cards__info__value">{elem.cpu}136ms</span>
            </div>
            <div>
              <span className="all-cards__info__name">Memory</span>
              <span className="all-cards__info__value">{elem.memory}ms</span>
            </div>
          </div>
          <div className="all-cards--card--location">
            <div className="all-cards__info__name">Location</div>
            <div className="all-cards__info__value">{elem.location.country}</div>
          </div>
