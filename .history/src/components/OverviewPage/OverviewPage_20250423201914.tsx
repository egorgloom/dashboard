...
import { ExtendedHistoricalData, IHistoricalData, IMetrics } from '../../interfaces/interface';
...
const OverviewPage: FC<IOverviewPage> = () => {
    ...
    const handleChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
      ...
      const filteredData = data?.map(item => processData(item));
    ...
    return (
        <>
            <div className='wrapper'>
                ...
                {filteredData?.map((elem: any) => <ItemCard elem={elem} key={elem.id}/>)}
